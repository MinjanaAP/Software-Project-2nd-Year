            ...
            <div class="accordion-body col-sm-8 col-xl-8 col-12 mb-5" id="adsContainer" >
                <div class="container empty-ads mt-3">
                    <div class="heading d-flex flex-column justify-content-center align-items-center">
                        ...
                        <h4 class="emptyads-title web h4 m-0">You have not uploaded any ads yet.</h4>
                        <p>Post  your ads <a href="/freeAd1">here .</a> </p>
                    </div>
...
<script>
                ...
                var adHTML =  '<div class="viewAds p-2">' +
                                            ...
                                            '</div>' +
                                                '<div class="adDetails my-2 p-2">' +
                                                    ...
                                                    '<button type="button" class="btn btn-outline-danger mb-2" onclick="deleteAd(' + item.id + ', \'' + item.status + '\')" style="width:100%"> Delete Ad <i class="bi bi-trash ms-2"></i></button>' +
    ...
    function deleteAd(itemId, status) {
        if (status === 'pending') {
            Swal.fire({
        ...
        function deleteAdFunction(itemId){
            $.ajax({
                        url: baseUrl +'/api/free_adCreate',
                        type: 'DELETE',
                        data: {
                            id: itemId
                        },
